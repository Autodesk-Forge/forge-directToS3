...
namespace Forge_Upload_DirectToS3
{
    class Program
    {
        ...
        public static dynamic GetToken()
        {
            ...
            request.AddParameter("application/x-www-form-urlencoded", $"client_id={clientId}&client_secret={clientSecret}&grant_type=client_credentials&scope=data%3Aread%20data%3Awrite%20data%3Acreate%20bucket%3Aread%20bucket%3Acreate", ParameterType.RequestBody);
